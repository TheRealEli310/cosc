...
local sPath = parentShell and parentShell.path() or ".:/.editor/programs"
...
if #tArgs > 0 then
    ...
    while not bExit do
        ...
        write(#shell.dir() > 0 and "/" .. shell.dir() .. " " or "") -- write dir with space if needed
        term.setTextColour(promptColour)
        write("$ ") -- write "$ " to start for reading
        term.setTextColour(textColour)
